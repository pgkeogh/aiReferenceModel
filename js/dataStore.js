...
export const uiElements = {
  ...
  closeProductModalButtonAlt: document.getElementById(
  ...
  clearProductSelectionButton: document.getElementById(
  ...
  productCapabilitiesCheckboxes: document.getElementById(
  ...
  // NEW: Add references to the capability containers
  infrastructureDataCapabilitiesContainer: document.getElementById(
    "infrastructure-data-capabilities-container"
  ),
  aiPlatformCapabilitiesContainer: document.getElementById(
